package com.kang.webRnote.web;


import cn.hutool.core.util.StrUtil;
import com.kang.webRnote.po.Note;
import com.kang.webRnote.po.NoteType;
import com.kang.webRnote.po.User;
import com.kang.webRnote.service.NoteService;
import com.kang.webRnote.service.NoteTypeService;
import com.kang.webRnote.vo.ResultInfo;
...
public class NoteServlet extends HttpServlet {
    ...
    private void addOrUpdate(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        // 3. 判断resultInfo的code值，根据code值判断成功失败
        //如果添加or修改成功进入indexServlet中刷线主页，否则失败的话，退回到原先的修改前的云记页面(所以需要根据NoteId来判断)
        if (resultInfo.getCode() == 1) {//成功了
            // 重定向跳转到首页 index
