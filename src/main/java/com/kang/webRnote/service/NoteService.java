package com.kang.webRnote.service;

import cn.hutool.core.util.StrUtil;
import com.kang.webRnote.dao.NoteDao;
import com.kang.webRnote.po.Note;
import com.kang.webRnote.util.Page;
...
public class NoteService {
    ...
    public Page<Note> findNoteListByPage(String pageNumStr, String pageSizeStr, Integer userId,
        ...
        // 得到数据库中分页查询开始的下标，因为在sql中使用limit分页查询需要两个值：从哪开始、查多少行
