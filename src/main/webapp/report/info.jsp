...
<script type="text/javascript" src="https://api.map.baidu.com/api?v=1.0&&type=webgl&ak=i8Ebh9DMc9CZ0uugEfkdg3HcGx4gW6wQ"></script>
...
<script type="text/javascript">
    ...
    function loadBaiduMap(markers) {
        ...
        // 判断是否有坐标
        if (markers != null && markers.length > 0) {  // 集合中第一个坐标时用户当前所在位置，其他的是云记记录中的对应的经纬度
            // 将用户所在位置设置为中心点
