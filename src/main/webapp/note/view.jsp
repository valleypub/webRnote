...
<div class="col-md-9">
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=i8Ebh9DMc9CZ0uugEfkdg3HcGx4gW6wQ"></script>
    <script type="text/javascript">
        /* 百度地图获取当前位置经纬度 */
        var geolocation = new BMap.Geolocation();//通过这个方法就可以获取当前位置经纬度
